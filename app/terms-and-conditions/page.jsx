...
export const metadata = {
  title: "Terms and Conditions — Vantage Marketing",
      ...
      <div className="theme-corporate">
        <div className="dark-mode">
          <div className="page bg-dark-1" id="top">
            ...
            <main id="main" className="page-section text-white">
              <div className="container position-relative">
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Vantage
                      Marketing, 123 Main St, Arkansas, USA.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Vantage Marketing,
                      accessible from{" "}
                      <a
                        href="https://vantage-marketing.pages.dev"
                        rel="external nofollow noopener"
                        target="_blank"
                      >
                        https://vantage-marketing.pages.dev
                      </a>
                    </p>
                  </li>
                  <li>
                ...
                <ul>
                  <li>
                    By email:{" "}
                    <a
                      href="mailto:hello@vantage-marketing.pages.dev"
                      className="text-primary"
                    >
                      hello@vantage-marketing.pages.dev
                    </a>
                  </li>
                </ul>
              </div>
